...
export default function KakaoShareButton() {
  ...
  return (
    <button
      ...
      className="fixed bottom-6 right-5 z-50 flex flex-col items-center justify-center w-[3.6rem] h-[3.6rem] rounded-full bg-kakao text-[#3C1E1E] active:scale-95 transition-transform"
    >
      ...
      <span className="font-hand text-[12px] leading-none mt-0.5">카톡공유</span>
    </button>
  );
}
